...
import 'package:commerce/utils/Global.dart';
...
class _ShowState extends State<Show> {
                ...
                children: [
                  ...
                  Positioned(
                      ...
                      child: Container(
                          ...
                          child: Center(
                              child: Text(Global.cartProducts.length.toString(),
                                  style: TextStyle(
  ...
  Widget _makeCardProduct(Product product) {
    return Card(
      child: Column(
        children: [
          SizedBox(height: 7),
          Text(product.name, style: TextStyle(color: normal, fontSize: 18)),
          ...
          Row(
            ...
            children: [
              InkWell(
                  ...
                  child: Icon(Icons.shopping_cart, size: 25, color: accent)),
              Text("3500 Ks", style: TextStyle(color: normal, fontSize: 18)),
              Icon(Icons.visibility, size: 25, color: accent)
            ],
          )
        ],
      ),
  ...
  Widget _makeNavBarItem(index, Tag tag) {
    return Container(
      ...
      child: Column(
        children: [
          GestureDetector(
              ...
              child: Text(tag.name, style: TextStyle(fontSize: 18))),
          SizedBox(height: 5),
          Container(
            height: 3,
            width: 50,
